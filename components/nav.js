        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#" className="text-gray-300 hover:text-white transition-colors">Skills</a>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-[#0B0F19] border-b border-white/10">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <a href="#" className="block px-3 py-2 text-gray-300 hover:text-white">Skills</a>
              <a href="#" className="block px-3 py-2 text-gray-300 hover:text-white">Portfolio</a>
