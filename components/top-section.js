            ...
            <div className='space-y-8 lg:text-left text-center'>
              ...
              <div>
                <h1 className='text-6xl sm:text-7xl font-bold mb-6'>
                  <span
                    ref={typedRef}
                    className='bg-gradient-to-r from-[#9933FF] to-[#FF3366] text-transparent bg-clip-text'
                  ></span>
                </h1>
                <p className='text-xl mb-8 text-gray-300'>
                  ...
                  with a passion & deep commitment for building scalable,
                ...
                <div className='flex justify-center lg:justify-start'>
                  <button className='relative group'>
                    ...
                    <div className='relative px-7 py-4 bg-[#0B0F19] rounded-lg leading-none'>
                      <span
                        className='bg-gradient-to-r from-[#33CCFF] to-[#FF3366] text-transparent bg-clip-text font-semibold'
