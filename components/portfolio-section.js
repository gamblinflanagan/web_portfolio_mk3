  ...
  const portfolioItems = [
    {
      ...
      video:
        'https://drive.google.com/file/d/1ZsSLsyjD9N70E3snihBeiMmxS76qkdA9/preview',
      image: '',
      description:
        'I was the sol developer for an airbnb business tasked with creating their company website',
    },
    {
      link: 'https://github.com/gamblinflanagan/Alarm-Clock',
      title: 'Alarm Clock',
      video:
        'https://drive.google.com/file/d/1tG5X7ZEjV32QcS-5zpbjmydlMfrDcDV0/preview',
      image:
        'https://images.unsplash.com/photo-1557821552-17105176677c?q=80&w=1000&auto=format&fit=crop',
      description:
        'At a time set by the user a random classical song will play and the voice will tell the user the exact date, time, and weather specific to the set location. The greeting ie: (Good morning sir, I hope you slept well sir) is completley customizeable for the user.',
    },
    {
      link: 'https://nj-homeless-donation-website.web.app',
      title: 'NJ Homeless Donation site',
      video:
        'https://drive.google.com/file/d/1N2QM1RhYVii9auXoulnrPKG_svBGnlgC/preview',
      image: '',
      description:
        'Donation site that I created for Livingston Philanthropies inc',
    },
    {
      link: 'https://cs490-project2m2-jcf29.herokuapp.com',
      title: 'Chit Chat Messaging',
      video:
        'https://drive.google.com/file/d/1LbD14jp2Or7p_URdKP6nRI4QgLe9YTp0/preview',
      image: '',
      description:
        'Flask/React Web chat app I designed and built my senior year of college',
    },
    {
      link: 'https://github.com/gamblinflanagan/angular-react-app',
      title: 'Angular React App template',
      video:
        'https://drive.google.com/file/d/1vWvnlEQTmqE-j1v95DadX7Zx9tB7efOZ/preview',
      image: '',
      description:
        'I created a template to build Angular webapps with React running inside for added performance but with all features of a js framework',
    },
    // {
    ...
    // },
    {
      ...
      video:
        'https://drive.google.com/file/d/1PPAwV57THDUHep6Xyt5uYksN6tyfKoZN/preview',
      image: '',
      description:
        'Python app of the classic big bang theory game rock paper scissors lizard spock',
    },
    // {
    ...
    // },
    {
      ...
      video:
        'https://drive.google.com/file/d/12xgW4uvjDt_OftYEFk8c3DpxMRuClTV_/preview',
      image: '',
      description:
        'The RPA bot will open the tic tac toe website and play the AI usng the minimax algorithm to decide its move Works on all Windows platforms with Workfusion installed.',
    },
    // {
    ...
    // },
    {
      ...
      video:
        'https://drive.google.com/file/d/1QsG1XsFcA70X8YQpsQSt4fZc3OdgCi7R/preview',
      image: '',
      description:
        'Python app that takes a number of the decimal, hexadecimal, or binary systems and coverts it to the other 2 systems',
    },
    {
      link: 'https://cs490-project1-jcf29.herokuapp.com',
      title: 'Recipe Website',
      video:
        'https://drive.google.com/file/d/1j4YFFWthdL6OW1NkNBvBPFSeFp79hYId/preview',
      image: '',
      description:
        'Flask app that displays random recipe from API and displays tweets about it',
    },
    // {
      ...
      <section className='py-20 relative' ref={portfolioRef}>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative'>
          ...
          <div className='h-[48rem] overflow-y-scroll '>
            <div
              className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-stagger ${
                isPortfolioInView ? 'in-view' : ''
              }`}
            >
